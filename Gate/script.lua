...
o2gate = createObject ( 16775, -718.40002,954.70001 ,15.1, 0, 0, 90 )
o2col = createColCircle ( -718.40002,954.70001 ,8.1)

function openo2gate(thePlayer)
	if getElementData(thePlayer, "logedin") == true then
		if tonumber(getElementData(accSys:getPlayerAcc(thePlayer), "Map")) == 20 then
			moveObject(o2gate,2000,-718.40002,954.70001 ,1.17)
			setTimer(
			function()
				moveObject(o2gate,2000,-718.40002,954.70001 ,15.1)
			end, 30000, 1)
		end
	end
end
addEventHandler( "onColShapeHit", o2col, openo2gate )

function closeo2gate(thePlayer)
	if getElementData(thePlayer, "logedin") == true then
		if tonumber(getElementData(accSys:getPlayerAcc(thePlayer), "Map")) == 20 then
			moveObject(o2gate,2000,-718.40002,954.70001 ,15.1)
		end
...
addEventHandler( "onColShapeLeave", o2col, closeo2gate )



o2_1gate = createObject ( 16775, -664.7529296875 ,954.1162109375 ,14.5328125 , 0, 0, 90 )
o2_1col = createColCircle ( -664.7529296875 ,954.1162109375 ,4 )

function openo2_1gate(thePlayer)
	if getElementData(thePlayer, "logedin") == true then
		if tonumber(getElementData(accSys:getPlayerAcc(thePlayer), "Map")) == 20 then
			moveObject(o2_1gate,2000,-664.7529296875 ,954.1162109375 ,1.1328125 )
			setTimer(
			function()
				moveObject(o2_1gate,2000,-664.7529296875 ,954.1162109375 ,14.5328125 )
			end, 30000, 1)
		end
	end
end
addEventHandler( "onColShapeHit", o2_1col, openo2_1gate )

function closeo2_1gate(thePlayer)
	if getElementData(thePlayer, "logedin") == true then
		if tonumber(getElementData(accSys:getPlayerAcc(thePlayer), "Map")) == 20 then
			moveObject(o2_1gate,2000,-664.7529296875 ,954.1162109375 ,14.5328125 )
		end
...
addEventHandler( "onColShapeLeave", o2_1col, closeo2_1gate )


o2_2gate = createObject ( 980, -691.20001,954.90002,14, 0, 0, 90 )
o2_2col = createColCircle ( -691.20001,954.90002,4)

function openo2_2gate(thePlayer)
	if getElementData(thePlayer, "logedin") == true then
		if tonumber(getElementData(accSys:getPlayerAcc(thePlayer), "Map")) == 20 then
			moveObject(o2_2gate,2000,-691.20001,954.90002,1)
			setTimer(
			function()
				moveObject(o2_2gate,2000,-691.20001,954.90002,14)
			end, 30000, 1)
		end
	end
end
addEventHandler( "onColShapeHit", o2_2col, openo2_2gate )

function closeo2_2gate(thePlayer)
	if getElementData(thePlayer, "logedin") == true then
		if tonumber(getElementData(accSys:getPlayerAcc(thePlayer), "Map")) == 20 then
			moveObject(o2_2gate,2000,-691.20001,954.90002,14)
		end
...
addEventHandler( "onColShapeLeave", o2_2col, closeo2_2gate )



o2_3gate = createObject ( 980, -652.59003,955,13.9, 0, 0, 90 )
o2_3col = createColCircle (  -652.59003,955,5)

function openo2_3gate(thePlayer)
	if getElementData(thePlayer, "logedin") == true then
		if tonumber(getElementData(accSys:getPlayerAcc(thePlayer), "Map")) == 20 then
			moveObject(o2_3gate,1000,-652.59003,955,1)
			setTimer(
			function()
				moveObject(o2_3gate,1000,-652.59003,955,13.9)
			end, 30000, 1)
		end
	end
end
addEventHandler( "onColShapeHit", o2_3col, openo2_3gate )

function closeo2_3gate(thePlayer)
	if getElementData(thePlayer, "logedin") == true then
		if tonumber(getElementData(accSys:getPlayerAcc(thePlayer), "Map")) == 20 then
			moveObject(o2_3gate,1000,-652.59003,955,13.9)
		end
...
addEventHandler( "onColShapeLeave", o2_3col, closeo2_3gate )





o2_4gate = createObject ( 980, -736.12,952.20001,13.66, 0, 0, 90 )
o2_4col = createColCircle (  -736.12,952.20001,5)

function openoo2_4gate(thePlayer)
	if getElementData(thePlayer, "logedin") == true then
		if tonumber(getElementData(accSys:getPlayerAcc(thePlayer), "Map")) == 20 then
			moveObject(o2_4gate,1000,-736.12,952.20001,1)
			setTimer(
			function()
				moveObject(o2_4gate,1000,-736.12,952.20001,13.66)
			end, 30000, 1)
		end
	end
end
addEventHandler( "onColShapeHit", o2_4col, openoo2_4gate )

function closeo2_4gate(thePlayer)
	if getElementData(thePlayer, "logedin") == true then
		if tonumber(getElementData(accSys:getPlayerAcc(thePlayer), "Map")) == 20 then
			moveObject(o2_4gate,1000,-736.12,952.20001,13.66)
		end
...
addEventHandler( "onColShapeLeave", o2_4col, closeo2_4gate )
-------------------------------
...
function openmmraminGate(thePlayer)
	if getElementData(thePlayer, "logedin") == true then
		if tonumber(getElementData(accSys:getPlayerAcc(thePlayer), "Map")) == 30 then
...
mMahdim2Gate = createObject ( 16775,  2251.1572265625 ,2498.4759765625 ,5.278355598449 , 0, 0, 90 )
mMahdim2Col = createColCircle (  2251.1572265625 ,2497.8759765625 ,6.278355598449  )

function openmMahdim2Gate(thePlayer)
	if getElementData(thePlayer, "logedin") == true then
		local account = getAccountName(getPlayerAccount(thePlayer))
		if isObjectInACLGroup("user."..account,aclGetGroup("Map17")) then
			moveObject(mMahdim2Gate,1000,   2251.1572265625 ,2498.4759765625 ,-5.278355598449    )
			setTimer(
			function()
				moveObject(mMahdim2Gate,1000,  2251.1572265625 ,2498.4759765625 ,5.278355598449  )
			end, 30000, 1)
...
addEventHandler( "onColShapeHit", mMahdim2Col, openmMahdim2Gate )

function closemMahdim2Gate(thePlayer)
	if getElementData(thePlayer, "logedin") == true then
		local account = getAccountName(getPlayerAccount(thePlayer))
		if isObjectInACLGroup("user."..account,aclGetGroup("Map17")) then
			moveObject(mMahdim2Gate,1000,  2251.1572265625 ,2498.4759765625 ,5.278355598449 )
...
addEventHandler( "onColShapeLeave", mMahdim2Col, closemMahdim2Gate)
