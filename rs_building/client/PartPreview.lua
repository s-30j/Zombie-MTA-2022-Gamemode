...
local function buildPart()
    ...
    --local createMishe = getElementData(localPlayer, "buildcreate")
    --if createMishe == true then
        local building = BuildingClient.getPartBuilding(targetObject)
        local x, y, z
        local nameMan = localPlayer
        local direction
        ...
        triggerServerEvent("buildPart", building, PartPreview.partName, x, y, z, previewDirection,nameMan)
    --else
    --end
end
...
bNameChill = "Chill"
function BiaChillBezarBaram()
    PartPreview.showPart(bNameChill)
end
bNameWallWindow = "WallWindow"
function BiaWallWindowBezarBaram()
    PartPreview.showPart(bNameWallWindow)
end
bNameWallDoor = "WallDoor"
function BiaWallDoorBezarBaram()
    PartPreview.showPart(bNameWallDoor)
end
bNameFloor = "Floor"
function BiaFloorBezarBaram()
    PartPreview.showPart(bNameFloor)
end
bNameFoundation = "Foundation"
function BiaFoundationBezarBaram()
    PartPreview.showPart(bNameFoundation)
end
bNameWall = "Wall"
function biaWallBezarBaram()
    PartPreview.showPart(bNameWall)
end
function pakKonHamaro()
        PartPreview.hidePart()
end