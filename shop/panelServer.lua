...
function jzh1(thePlayer)
	if tonumber(getElementData(accSys:getPlayerAcc(thePlayer), "c25")) == 0 then

		outputChatBox("#46C2EB Shoma 2000 ZP Daryaft Kardid", thePlayer, 255, 255, 0,true)
		...
		setElementData(accSys:getPlayerAcc(thePlayer), "c25", 2)
	else
		outputChatBox("#ff0000 Shoma 2000 ZP Az Ghabl Daryaft Kardid!", thePlayer, 255, 255, 0,true)
	end
end
addEvent("Jzh1",true)
addEventHandler("Jzh1", root, jzh1)
...
function hoverboard(player)
	...
	if HoverTabla[player] == nil then
		local ski = getElementData(accSys:getPlayerAcc(player), "ski")
		if ski > 0 then

			local skiPlayer = getElementData(accSys:getPlayerAcc(player), "ski")
			setElementData(accSys:getPlayerAcc(player), "ski", tonumber(skiPlayer) - 1)
			local id = 462
			local slots = 0
			local tires = 0
			local engine = 0
			...
			setElementData ( HoverTabla[player], "hoverOwner", myName )
			...
			setVehicleHandling ( HoverTabla[player] , "maxVelocity", 120 )
			setVehicleHandling ( HoverTabla[player] , "driveType" , "awd" )

			local mySki = getElementData(accSys:getPlayerAcc(player), "ski")
			outputChatBox("#00ff00 Shoma Ek Ski Daryaft Kardid", player, 255, 255, 0,true)
			outputChatBox("#00ff00 Va "..mySki.." Ski Digar Darid", player, 255, 255, 0,true)
		else
			outputChatBox("#ff0000 Shoma Ski Nadarid", player, 255, 255, 0,true)
		end

	else
		outputChatBox("#ff0000 Shoma Ek Ski Az Ghabl Darid Baraye Delete Bezan /delski", player, 255, 255, 0,true)
	end
end
addEvent("Jzh2",true)
addEventHandler("Jzh2", root, hoverboard)

addCommandHandler("delski",
function (player)
	if HoverTabla[player] == nil then
		outputChatBox("#ff0000 Shoma Hich Ski Baraye Delete Nadarid", player, 255, 255, 0,true)
	else
		destroyElement(HoverTabla[player])
		HoverTabla[player] = nil
		outputChatBox("#00ff00 Ski Shoma Pak Shod✔", player, 255, 255, 0,true)
	end
end)

addCommandHandler("myski",
function (thePlayer)
	local mySki = getElementData(accSys:getPlayerAcc(thePlayer), "ski")
	outputChatBox("#00ff00 Shoma "..mySki.." Ski Darid", thePlayer, 255, 255, 0,true)
end)

function BedeSki(thePlayer)
	if tonumber(getElementData(accSys:getPlayerAcc(thePlayer), "ZP")) > 19 then

		local skiPlayer = getElementData(accSys:getPlayerAcc(thePlayer), "ski")
		setElementData(accSys:getPlayerAcc(thePlayer), "ski", tonumber(skiPlayer) + 1)

		outputChatBox("#46C2EB Shoma Ski Ba 20 ZP Kharidid", thePlayer, 255, 255, 0,true)
		triggerClientEvent("PlayDaryaft", thePlayer, thePlayer)
		local tedad = 20
		local ZpPlayer = getElementData(accSys:getPlayerAcc(thePlayer), "ZP")
		setElementData(accSys:getPlayerAcc(thePlayer), "ZP", tonumber(ZpPlayer) - tonumber(tedad))
...
addEvent("BedeSki",true)
addEventHandler("BedeSki", root, BedeSki)


function BedeVIP(thePlayer)
		local username = tostring(getPlayerSerial(thePlayer))
		local account = getAccount(username)
		if isObjectInACLGroup("user."..username,aclGetGroup("VIP")) then
			outputChatBox("#ff00ff Shoma Vip Hastid", thePlayer, 255, 255, 0,true)
		else
			aclGroupAddObject (aclGetGroup("VIP"), "user."..username)
			aclSave ()
		end
end
addEvent("BedeVIP",true)
addEventHandler("BedeVIP", root, BedeVIP)
...
function BedeV1(thePlayer)
	if tonumber(getElementData(accSys:getPlayerAcc(thePlayer), "ZP")) > 489 then
		...
		exports["web"]:sendDiscordMessage(getPlayerName(thePlayer).." Heli MH6J Ra Ba 490 ZP Kharid")
		triggerClientEvent("PlayDaryaft", thePlayer, thePlayer)
		local tedad = 490
		local ZpPlayer = getElementData(accSys:getPlayerAcc(thePlayer), "ZP")
		setElementData(accSys:getPlayerAcc(thePlayer), "ZP", tonumber(ZpPlayer) - tonumber(tedad))
...
function BedeV2(thePlayer)
	if tonumber(getElementData(accSys:getPlayerAcc(thePlayer), "ZP")) > 499 then
		...
		exports["web"]:sendDiscordMessage(getPlayerName(thePlayer).." Heli AH6J Ra Ba 500 ZP Kharid")
		triggerClientEvent("PlayDaryaft", thePlayer, thePlayer)
		local tedad = 500
		local ZpPlayer = getElementData(accSys:getPlayerAcc(thePlayer), "ZP")
		setElementData(accSys:getPlayerAcc(thePlayer), "ZP", tonumber(ZpPlayer) - tonumber(tedad))
...
function BedeV3(thePlayer)
	if tonumber(getElementData(accSys:getPlayerAcc(thePlayer), "ZP")) > 180 then
		...
		exports["web"]:sendDiscordMessage(getPlayerName(thePlayer).." Motor Ra Ba 180 ZP Kharid")
		triggerClientEvent("PlayDaryaft", thePlayer, thePlayer)
		local tedad = 180
		local ZpPlayer = getElementData(accSys:getPlayerAcc(thePlayer), "ZP")
		setElementData(accSys:getPlayerAcc(thePlayer), "ZP", tonumber(ZpPlayer) - tonumber(tedad))
...
function BedeV4(thePlayer)
	if tonumber(getElementData(accSys:getPlayerAcc(thePlayer), "ZP")) > 199 then
		...
		exports["web"]:sendDiscordMessage(getPlayerName(thePlayer).." UAZ Ra Ba 200 ZP Kharid")
		triggerClientEvent("PlayDaryaft", thePlayer, thePlayer)
		local tedad = 200
		local ZpPlayer = getElementData(accSys:getPlayerAcc(thePlayer), "ZP")
		setElementData(accSys:getPlayerAcc(thePlayer), "ZP", tonumber(ZpPlayer) - tonumber(tedad))
...
function BedeV5(thePlayer)
	if tonumber(getElementData(accSys:getPlayerAcc(thePlayer), "ZP")) > 349 then
		...
		exports["web"]:sendDiscordMessage(getPlayerName(thePlayer).." FBI Ra Ba 350 ZP Kharid")
		triggerClientEvent("PlayDaryaft", thePlayer, thePlayer)
		local tedad = 350
		local ZpPlayer = getElementData(accSys:getPlayerAcc(thePlayer), "ZP")
		setElementData(accSys:getPlayerAcc(thePlayer), "ZP", tonumber(ZpPlayer) - tonumber(tedad))
