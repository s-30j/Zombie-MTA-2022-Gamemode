...
txd = engineLoadTXD("models/chest.txd", 3392 )
engineImportTXD(txd, 3392)
dff = engineLoadDFF("models/chest.dff", 3392 )
engineReplaceModel(dff, 3392)
col = engineLoadCOL("models/chest.col")
engineReplaceCOL(col, 3392)
